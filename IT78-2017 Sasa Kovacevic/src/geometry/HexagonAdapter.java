...
public class HexagonAdapter extends SurfaceShape{
	private Hexagon hexagon; //jar
	
	/* U nasim klasama metoda za crtanje je draw, dok je kod hex paint. 
	 * U hex adapter klasi pravim ista imena
	 * metoda nasih oblika i na osnovu instance Hexagon hexagon
	 * mi kad neko pozove draw u adapteru pozivamo paint.
	 */
